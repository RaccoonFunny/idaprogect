<template>
  <div :class="$style.item">
    <div :class="$style.head">
      ...
      <div>
        <svg @click="addInCart" :class="[{ [$style.open]: isInCart}, $style.shopingBag]" width="12" height="14"
    ...
    <img :src="'https://frontend-test.idaproject.com' + good.photo" alt="">
...
export default {
  ...
  methods: {
    addInCart: function () {
      ...
      this.$store.dispatch("shopGoods/addGoodInCart", this.good)
    }
  },
  computed: {
    isInCart: function () {
      return this.$store.getters["shopGoods/getGoodStatus"](this.good.id);
    }
  }
}
</script>
